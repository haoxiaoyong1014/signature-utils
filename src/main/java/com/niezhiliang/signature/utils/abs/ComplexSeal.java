...
import com.niezhiliang.signature.utils.abs.AbstractComplexSeal;
 ...
 * <p>
 * 复杂级圆形签章,签章中包含: 公司名称,★,title(什么什么专用章),副文字(1233443545)
 * 复杂级椭圆签章,签章中包含: 公司名称,title(什么什么专用章),副文字(1234566788),★
 */
public class ComplexSeal extends AbstractComplexSeal {
    ...
    public String drawCircle(SealInfo sealInfo) {
        try {
            ...
            //画 title
            this.drawFont(g2d, (borderCircleWidth + INIT_BEGIN) * 2, (borderCircleHeight + INIT_BEGIN) * 2, conf.getTitleFont());
            //画 副文字
            this.drawArcFont4Circle(g2d, borderCircleHeight, conf.getViceFont(), false);
            g2d.dispose();
    ...
    public String drawEllipse(SealInfo sealInfo) {
        try {
            ...
            //画 title
            this.drawFont(g2d, (borderCircleWidth + 8) * 2, (borderCircleHeight + 20) * 2, conf.getTitleFont());
            //画副文字
            this.drawArcFont4Oval(g2d, conf.getBorderCircle(), conf.getViceFont(), false);
            //画星
            this.drawFont(g2d, (borderCircleWidth + INIT_BEGIN) * 2, (borderCircleHeight + INIT_BEGIN) * 2, conf.getCenterFont());
            g2d.dispose();
            String base = this.buildAndStoreSeal(bufferedImage);
