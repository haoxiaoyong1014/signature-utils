 ...
 * 创建抽象产品类,定义抽象产品的公共接口
 */
public abstract class AbstractComplexSeal extends AbstractBasicSeal {
    ...
    public SealConfiguration sealConfigCircle(SealInfo sealInfo) {
        ...
        SealConfiguration sealConfigurationComplex = sealCircle.setSerNoFont(sealInfo, sealConfigurationSimple);
        return sealConfigurationComplex;
    }
    ...
    public SealConfiguration sealConfigEllipse(SealInfo sealInfo) {
        ...
        SealConfiguration sealConfigurationComplex = sealEllipse.setCenterFont(sealInfo, sealConfigurationSimple);
        return sealConfigurationComplex;
    }
}
